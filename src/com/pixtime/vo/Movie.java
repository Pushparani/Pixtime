...
public class Movie {
	...
	public Movie(String id, String movieName, String description,
			...
			int current_Star_Rate, String uploaded_Date,
			String site_display_status, String rating_End_Date,
			String specialNotes, String encodedImg, String director,
			String producedBy, String cast) {
		super();
		this.movieId = id;
